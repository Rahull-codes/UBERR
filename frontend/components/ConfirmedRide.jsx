  ...
  return (
    <div>
      ...
      <h5 onClick={()=>{
        ...
        <h3 className="text-xl font-semibold mb-5">Confirm your Ride <i className="ri-taxi-fill"></i> </h3>
        ...
        className='w-full mt-5 bg-green-600 text-lg font-semibold p-2 rounded-lg '>Confirm</button>
        </div> 
    </div>
  )
}
